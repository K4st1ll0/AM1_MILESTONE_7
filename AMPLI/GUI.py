...
class MainWindow(QWidget):
    def __init__(self):
        ...
        self.Cuerpo_central.addItems(["Tierra", "Luna", "Marte", "Venus", "Jupiter", "Saturno", "Urano", "Neptuno", "Mercurio", "Sol"])
        ...
        self.central_body.addItems(["Tierra", "Luna", "Marte", "Venus", "Jupiter", "Saturno", "Urano", "Neptuno", "Mercurio", "Sol"])

        self.primary_body = QComboBox()
        self.primary_body.addItems(["Tierra", "Luna", "Marte", "Venus", "Jupiter", "Saturno", "Urano", "Neptuno", "Mercurio", "Sol"])
        ...
        form_propagate.addRow("Tamano de paso inicial:", self.initial_step_size)
        form_propagate.addRow("Precision (accuracy):", self.accuracy)
        form_propagate.addRow("Paso minimo:", self.min_step_size)
        form_propagate.addRow("Paso maximo:", self.max_step_size)
        form_propagate.addRow("Intentos max. paso:", self.mas_step_attemps)
        ...
        form_propagate.addRow("Atmosfera:", self.drag_atmosphere_model)
        ...
        self.origin.addItems(["Tierra", "Luna", "Marte", "Venus", "Jupiter", "Saturno", "Urano", "Neptuno", "Mercurio", "Sol"])
        ...
        self.variable_reportfile.addItems([
                                            ...
                                            "Jupiter VX", "Jupiter VY", "Jupiter VZ",
        ...
        # --- BOTON GUARDAR DATOS ---
        # ==========================================================
        # Anadir pestanas y generar datos
    ...
    def update_spacecraft_fields(self): # Actualiza los campos del formulario segun el sistema de coordenadas seleccionado
        ...
        if self.coordinates.currentText() == "Cartesianas":
            ...
            self.form_spacecraft.addRow("Numero de tanques:", self.tanks_input)
    ...
    # ==========================================================
    # FUNCION PARA GUARDAR DATOS EN UN TXT
    # ==========================================================
    def guardar_datos(self): # Recopila los datos de todas las pestanas y los guarda en un archivo TXT
